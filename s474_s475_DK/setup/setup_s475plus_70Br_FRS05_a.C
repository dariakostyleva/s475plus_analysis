...
void setup_s475plus_70Br_FRS05_a()
{
 ...
 /*
  ...
  frs->dispersion[1]    =  4.20;  // RUN81-TA2B-220CM 27.05.2016
  frs->magnification[1] =  0.83;   // RUN81-TA2B-220CM 27.05.2016
  ...
  frs->bfield[0] = 9.8521; // FRS D1 for 124Xe// Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
  frs->bfield[1] = 8.7198; // D2 for 124Xe// Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
  //frs->bfield[2] = 7.739 ; // D3 for 124Xe// Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
  //frs->bfield[3] = 7.739 ; // D4 for 124Xe// Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
  //frs->bfield[2] = 7.7533 ; // D3 for 124Xe without TPC31// Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
  //frs->bfield[3] = 7.7533 ; // D4 for 124Xe without TPC31// Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
  frs->bfield[2] = 7.739 ; // D3 daria, 11.01.2021
  frs->bfield[3] = 7.739 ; // D4 daria, 11.01.2021
