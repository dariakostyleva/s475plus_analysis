...
void setup_s475plus_124Xe_FRS01()
{
 ...
 /*
  ...
  //-----distances updated on 2020/Feb/20 -----
  //S2
  frs->dist_focS2 = 2012.5; // degrader disk position
  frs->dist_MW21  =  604.0;
  frs->dist_MW22  = 1782.5;
  frs->dist_SC21  = 1554.5;
  frs->dist_SC22  = 2705.0; //measured on 2020/Feb/20 s467
  frs->dist_TPC21 =  604.0;
  frs->dist_TPC22 = 1782.5;
  frs->dist_TPC23 = 2960.0; //measured on 2020/Feb/20 s467
  frs->dist_TPC24 = 3985.0; //measured on 2020/Feb/20 s467
  frs->dist_S2target = 2460.5; //for some experiments

  //S4
  frs->dist_focS4   = 2349.0; //from SC411
  ...
  frs->dist_S4target= 6500.0; //for some experiments
  ...
  frs->bfield[0] = 12.7844; // FRS D1 for 124Xe// Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
  frs->bfield[1] = 12.7844; // D2 for 124Xe// Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
  frs->bfield[2] = 12.5024; // D3 for 124Xe// Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
  frs->bfield[3] = 12.5024; // D4 for 124Xe// Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
...
// TOF calibration SC21-SC81 (TAC)
  ...
  id->a2AoQCorr = 0.0;
  id->a4AoQCorr = 0.0;
  id->vel_a[0] =   7173.56; //  MUSIC41 velocity corr.
  id->vel_a[1] =  -13023.5; // -17462*1.096
  id->vel_a[2] =   6869.62; //  7682 *1.096
  id->vel_a[3] =   0.0;
  id->vel_a2[0] =  11149.64 ; // MUSIC42 like MUSIC41 (too high)
  id->vel_a2[1] = -20736.89 ;
  id->vel_a2[2] =  11031.86 ;
  id->vel_a2[3] =  0.0;
  id->vel_a3[0] =  13951.37; //MUSIC43 velocity corr. (old)
  id->vel_a3[1] = -38369.9;
  id->vel_a3[2] =  28396.46;
  id->vel_a3[3] =  0.0;
  id->id_tofoff2 =  232099.1;  // Offset (ps) 
  id->id_path2   =  122821.2;  // Path/c (ps) this number fit
  ...
  music->max_adc_music2 =    4096; //travel music //depends on setup in mdpp16
  music->max_adc_music3 =  0x2000; //tum music
  music->max_tdc_music1 =    4096; //tum music
  music->max_tdc_music2 =    4096; //travel music
  music->max_tdc_music3 = 0x10000; //tum music
  ...
  //TPC22
  tpc->lim_csum1[1][0] = 30.0;    tpc->lim_csum1[1][1] =  30.0;
  tpc->lim_csum2[1][0] = 30.0;    tpc->lim_csum2[1][1] =  30.0;
  tpc->lim_csum3[1][0] = 30.0;    tpc->lim_csum3[1][1] = 1800.0;
  tpc->lim_csum4[1][0] = 30.0;    tpc->lim_csum4[1][1] = 1800.0;
 
  //TPC31
  tpc->lim_csum1[6][0] = 30.0;    tpc->lim_csum1[6][1] = 2000.0;
  tpc->lim_csum2[6][0] = 30.0;    tpc->lim_csum2[6][1] = 2000.0;
  tpc->lim_csum3[6][0] = 30.0;    tpc->lim_csum3[6][1] = 2000.0;
  tpc->lim_csum4[6][0] = 30.0;    tpc->lim_csum4[6][1] = 2000.0;

  //TPC 1 at S2 (TPC 21) in vaccuum ////2020/feb/29
  tpc->id_tpc_timeref[0] = 1; //sc21
  tpc->timeref_calibrun[0] = 1034.; //sc21
  tpc->lim_csum1[0][0] = 1.0;    tpc->lim_csum1[0][1] = 500.0;
  tpc->lim_csum2[0][0] = 1.0;    tpc->lim_csum2[0][1] = 500.0;
  tpc->lim_csum3[0][0] = 30.0;    tpc->lim_csum3[0][1] = 30.0; // >>exclude
  tpc->lim_csum4[0][0] = 1.0;    tpc->lim_csum4[0][1] = 500.0;
  tpc->x_offset[0][0] = -25.043455;
  tpc->x_offset[0][1] = -46.732908;
  tpc->x_factor[0][0] = 0.069000;
  tpc->x_factor[0][1] = 0.068267;
  tpc->y_offset[0][0] = -50.504867;
  tpc->y_offset[0][1] = -47.830413;
  tpc->y_offset[0][2] = -47.832277;
  tpc->y_offset[0][3] = -52.953731;
  tpc->y_factor[0][0] = 0.031704;
  tpc->y_factor[0][1] = 0.031274;
  tpc->y_factor[0][2] = 0.031331;
  tpc->y_factor[0][3] = 0.031897;

  //TPC 2 at S2 (TPC 22) in vaccuum
  tpc->id_tpc_timeref[1] = 1; //sc21
  tpc->timeref_calibrun[1] = 1018.; //sc21
  ...
  tpc->id_tpc_timeref[2] = 1; //sc21
  tpc->timeref_calibrun[2] = 1044.; //sc21
  tpc->lim_csum1[2][0] = -1000.;   tpc->lim_csum1[2][1]= -1000.0; //2020/feb/29
  tpc->lim_csum2[2][0] = 400.0;    tpc->lim_csum2[2][1] =  800.0;
  tpc->lim_csum3[2][0] = 500.0;    tpc->lim_csum3[2][1] = 1200.0;
  tpc->lim_csum4[2][0] = 500.0;    tpc->lim_csum4[2][1] = 1000.0;
  tpc->x_offset[2][0] = 26.009232; //2020/feb/29 with respect to tpccalib trigger   
  tpc->x_offset[2][1] = 18.062480; //better y position, we need to subtract timeref data.    
  tpc->x_factor[2][0] = 0.065814; // S4742020Feb run_0112 Xe124
  tpc->x_factor[2][1] = 0.064979;
  tpc->y_offset[2][0] = 49.295312;
  tpc->y_offset[2][1] = 60.509721;
  tpc->y_offset[2][2] = 55.262669;
  tpc->y_offset[2][3] = 56.793862;
  tpc->y_factor[2][0] = -0.028694;
  tpc->y_factor[2][1] = -0.034165;
  tpc->y_factor[2][2] = -0.033795;
  tpc->y_factor[2][3] = -0.033537;

  
  //TPC 4 at S2 (TPC 24) in air
  tpc->id_tpc_timeref[3] = 1; //sc21
  tpc->timeref_calibrun[3] = 1063.0; //sc21
  tpc->lim_csum1[3][0] = 200.;     tpc->lim_csum1[3][1]= 700.0; //2020/feb/29 Xe124
  tpc->lim_csum2[3][0] = 100.0;    tpc->lim_csum2[3][1] = 700.0;
  tpc->lim_csum3[3][0] = 1000.0;   tpc->lim_csum3[3][1] = 1000.0; // exclude this one
  tpc->lim_csum4[3][0] = 100.0;    tpc->lim_csum4[3][1] = 700.0;
  tpc->x_offset[3][0] = 13.924035;//2020/feb/29 with respect to tpccalib trigger
  tpc->x_offset[3][1] = 18.610381;//better y position, we need to subtract timeref data. 
  tpc->x_factor[3][0] = 0.066909;  // (run0110 Xe124)
  tpc->x_factor[3][1] = 0.067320;
  tpc->y_offset[3][0] = 74.507374;
  tpc->y_offset[3][1] = 73.834665;
  tpc->y_offset[3][2] = 73.332399;
  tpc->y_offset[3][3] = 71.753969;
  tpc->y_factor[3][0] = -0.033172;
  tpc->y_factor[3][1] = -0.031972;
  tpc->y_factor[3][2] = -0.031909;
  tpc->y_factor[3][3] = -0.031704; 
  
  //TPC 5  at S4 (TPC 41) in air //29/Feb/2020 //run0134
  tpc->id_tpc_timeref[4] = 0; //sc41
  tpc->timeref_calibrun[4] = 456.2; //sc41
  tpc->lim_csum1[4][0] = 500.0;    tpc->lim_csum1[4][1] = 1000.0;
  tpc->lim_csum2[4][0] = 600.0;    tpc->lim_csum2[4][1] = 1000.0;
  tpc->lim_csum3[4][0] = 500.0;    tpc->lim_csum3[4][1] = 1200.0;
  tpc->lim_csum4[4][0] = 500.0;    tpc->lim_csum4[4][1] = 1000.0;
  tpc->x_offset[4][0] = -2.277291;
  tpc->x_offset[4][1] = 1.116471;
  tpc->x_factor[4][0] = 0.085452;
  tpc->x_factor[4][1] = 0.082974;
  tpc->y_offset[4][0] = 64.124271;
  tpc->y_offset[4][1] = 64.497051;
  tpc->y_offset[4][2] = 63.697916;
  tpc->y_offset[4][3] = 63.372075;
  tpc->y_factor[4][0] = -0.042452;
  tpc->y_factor[4][1] = -0.043194;
  tpc->y_factor[4][2] = -0.042319;
  tpc->y_factor[4][3] = -0.042207;

  //-------- TPC42 parameters (S4742020Feb run_0133 Xe124) --------//
  // TPC 6 at S4 (TPC 42) in air
  tpc->id_tpc_timeref[5] = 0; //sc41
  tpc->timeref_calibrun[5] = 434.9; //sc41
  tpc->x_offset[5][0] = -3.289716; //2020/Feb/29
  tpc->x_offset[5][1] = -3.562277;
  tpc->x_factor[5][0] = 0.084049;
  tpc->x_factor[5][1] = 0.086887;
  tpc->y_offset[5][0] = 57.883884;
  tpc->y_offset[5][1] = 57.943102;
  tpc->y_offset[5][2] = 56.615407;
  tpc->y_offset[5][3] = 56.461886;
  tpc->y_factor[5][0] = -0.041752;
  tpc->y_factor[5][1] = -0.042037;
  tpc->y_factor[5][2] = -0.043163;
  tpc->y_factor[5][3] = -0.042013; 
  tpc->lim_csum1[5][0] = 1000.0;    tpc->lim_csum1[5][1] = 1500.0;
  tpc->lim_csum2[5][0] = 1000.0;    tpc->lim_csum2[5][1] = 1500.0;
  tpc->lim_csum3[5][0] = 1000.0;    tpc->lim_csum3[5][1] = 1500.0;
  tpc->lim_csum4[5][0] = 1000.0;    tpc->lim_csum4[5][1] = 1500.0;

  //TPC at S3 (TPC 31)
   tpc->id_tpc_timeref[6] = 2; //sc31
  tpc->timeref_calibrun[6] = 500.0; //sc31
  ...
  //index 2 for Sc21
  sci->x_a[0][2] =    1207.71;  // quickly done for Be2513_sc21sc81_tpcs2_0170.lmd (2019/Dec)
  sci->x_a[1][2] =   -0.656967;  // quickly done for Be2513_sc21sc81_tpcs2_0170.lmd (2019/Dec)
 ...
 // sci->x_a[1][3] =  -0.7;  //
  sci->x_a[0][3] =  1674.29;  // also quickly done with run 0214
  sci->x_a[1][3] = -0.857143;  //
  ...
  // index 5 for Sc41
  sci->x_a[0][5] = 1116.35;  //  quickly done for frag_0052.lmd (2019/Nev)
  sci->x_a[1][5] = -0.8808;  //  quickly done for frag_0052.lmd (2019/Nev)
  ...
  // index 6 for Sc42
  sci->x_a[0][6] = 707.46;    // quickly done for frag_0052.lmd (2019/Nev)
  sci->x_a[1][6] = -0.656803; // quickly done for frag_0052.lmd (2019/Nev)
  ...
  */
  ...
  // this is not correct mapping!!!!!! 
  // here [i] is not ADC channel, but number defined in TFRSAnlProc.cxx
  // I make my best guess in the following part, but
  // swaspping and keep swapping (logbook p6) is very confusing... 
  // 
  // sci->tac_factor[0]  = 10.52;   //SC21L-R [ps/ch] 
  // sci->tac_factor[1]  = 10.7;    //SC41L-R [ps/ch] 
  // sci->tac_factor[2]  = 11.12;   //SC41L-SC21L [ps/ch] 
  // sci->tac_factor[3]  = 10.95;   //SC41R-SC21R [ps/ch] 
  // sci->tac_factor[4]  = 10.54;   //SC42L-R
  // sci->tac_factor[5]  = 21.9838; //SC42L-SC21L [ps/ch]
  // sci->tac_factor[6]  = 21.6361; //SC42R-SC21R [ps/ch] 
  // sci->tac_factor[7]  = 21.2356; //SC43L-R [ps/ch] 
  // sci->tac_factor[8]  = 21.2951; //SC81L-R [ps/ch] 
  // sci->tac_factor[9]  = 20.8417; //SC81L-SC21L
  // sci->tac_factor[10] = 19.9982; //SC81R-SC21R 
  // sci->tac_factor[11] = 10.5544; //SC22L-R
  // sci->tac_factor[12] = 20.0104; //SC41L-SC22L [ps/ch] 
  // sci->tac_factor[13] = 21.3619; //SC41R-SC22R [ps/ch] 
  // sci->tac_factor[14] = 20.3915; //SC81L-SC22L [ps/ch] 
  // sci->tac_factor[15] = 21.1293; //SC81R-SC22R [ps/ch]
  
  sci->tac_factor[0]  = 10.52;   //SC21L-R [ps/ch] 
  sci->tac_factor[1]  = 10.7;    //SC41L-R [ps/ch] 
  sci->tac_factor[2]  = 21.9838;   //SC41L-SC21L [ps/ch] 
  sci->tac_factor[3]  = 21.6361;   //SC41R-SC21R [ps/ch] 
  sci->tac_factor[4]  = 11.12;   //SC42L-R
  sci->tac_factor[5]  = 21.2951; //SC42L-SC21L [ps/ch]
  sci->tac_factor[6]  = 21.2356; //SC42R-SC21R [ps/ch] 
  sci->tac_factor[7]  = 10.95; //SC43L-R [ps/ch] 
  sci->tac_factor[8]  = 10.54; //SC81L-R [ps/ch] 
  sci->tac_factor[9]  = 20.8417; //SC81L-SC21L
  sci->tac_factor[10] = 19.9982; //SC81R-SC21R 
  sci->tac_factor[11] = 10.5544; //SC22L-R
  sci->tac_factor[12] = 20.0104; //SC41L-SC22L [ps/ch] 
