...
Bool_t TFRSAnalysis::InitEventClasses() 
{
  ...
  SetupH1("ID_AoQ_S2S4",2000,fIDPar->min_aoq_plot,fIDPar->max_aoq_plot,"A/Q S2-S4");
  SetupH1("ID_AoQ_corr_S2S4",2000,fIDPar->min_aoq_plot,fIDPar->max_aoq_plot,"A/Q S2-S4");
  SetupH1("ID_Z",1000,fIDPar->min_z_plot,fIDPar->max_z_plot,"Z from MUSIC41");
  SetupH1("ID_Z2",1000,fIDPar->min_z_plot,fIDPar->max_z_plot,"Z from MUSIC42");
  SetupH1("ID_Z3",1000,fIDPar->min_z_plot,fIDPar->max_z_plot,"Z from MUSIC43");
  SetupH2("ID_DBrho_AoQ",300,fIDPar->min_aoq_plot,fIDPar->max_aoq_plot,500,0.,2.5,"A/Q s2-s4", "Brho(ta-s2) - Brho(s2-s4) [Tm]");
  SetupH2("ID_x2AoQ", 300,fIDPar->min_aoq_plot,fIDPar->max_aoq_plot, 200,-100.,100.,"A/Q s2-s4", "X at S2 [mm]");
  SetupH2("ID_Z_AoQ", 300,fIDPar->min_aoq_plot,fIDPar->max_aoq_plot, 400,fIDPar->min_z_plot,fIDPar->max_z_plot,"A/Q s2-s4", "Z from MUSIC41");
  SetupH2("ID_Z_AoQcorr", 300,fIDPar->min_aoq_plot,fIDPar->max_aoq_plot, 300,fIDPar->min_z_plot,fIDPar->max_z_plot,"A/Q s2-s4 with correction", "Z from MUSIC41");
  ...
  SetupH2("ID_Z2_AoQ", 300,fIDPar->min_aoq_plot,fIDPar->max_aoq_plot, 400,fIDPar->min_z_plot,fIDPar->max_z_plot,"A/Q s2-s4", "Z from MUSIC42");
  SetupH2("ID_Z2_AoQcorr", 300,fIDPar->min_aoq_plot,fIDPar->max_aoq_plot, 300,fIDPar->min_z_plot,fIDPar->max_z_plot,"A/Q s2-s4 with correction", "Z from MUSIC42");
  SetupH2("ID_Z_Z2", 350,fIDPar->min_z_plot,fIDPar->max_z_plot, 350,fIDPar->min_z_plot,fIDPar->max_z_plot,"Z", "Z2");
  SetupH2("ID_Z_Z3", 250,fIDPar->min_z_plot,fIDPar->max_z_plot, 250,fIDPar->min_z_plot,fIDPar->max_z_plot,"Z", "Z3 'MUSIC'");
  SetupH2("ID_Z2_Z3", 250,fIDPar->min_z_plot,fIDPar->max_z_plot, 250,fIDPar->min_z_plot,fIDPar->max_z_plot,"Z", "Z3 'MUSIC'");
  SetupH2("ID_Z_Sc21E", 300, fIDPar->min_z_plot,fIDPar->max_z_plot ,400,0,4000.,"Z from MUSIC41", "sqrt(Sc21_L*sC21_R)");
  SetupH2("ID_x4AoQ", 100,fIDPar->min_aoq_plot,fIDPar->max_aoq_plot, 100,-100.,100.,"A/Q s2-s4", "X at S4 [mm]");
  SetupH2("ID_x4z", 300,fIDPar->min_z_plot,fIDPar->max_z_plot, 200,-100.,100., "Z from MUSIC41", "X at S4 [mm]");
  SetupH2("ID_x2z", 300,fIDPar->min_z_plot,fIDPar->max_z_plot, 200,-100.,100., "Z from MUSIC41", "X at S2 [mm]");
  SetupH1("ID_Z_sc81" ,1000,fIDPar->min_z_plot,fIDPar->max_z_plot,"Z from Sc81");
  SetupH1("ID_Z_s2tpc",1000,fIDPar->min_z_plot,fIDPar->max_z_plot,"Z from S2TPC");
  SetupH1("ID_AoQ_S2S8",2000,fIDPar->min_aoq_plot,fIDPar->max_aoq_plot,"A/Q S2-S8");
  SetupH2("ID_Z(sc81)_AoQ(s2s8)", 300,fIDPar->min_aoq_plot,fIDPar->max_aoq_plot, 400,fIDPar->min_z_plot,fIDPar->max_z_plot,"A/Q s2-s8", "Z from sc81");
  SetupH2("ID_Z(s2tpc)_AoQ(s2s8)", 300,fIDPar->min_aoq_plot,fIDPar->max_aoq_plot, 400,fIDPar->min_z_plot,fIDPar->max_z_plot,"A/Q s2-s8", "Z from s2tpc");
  SetupH2("ID_dE(sc81)_AoQ(s2s8)", 300,fIDPar->min_aoq_plot,fIDPar->max_aoq_plot, 400,1,2000,"A/Q s2-s8", "Z from sc81");
  SetupH2("ID_dE(s2tpc)_AoQ(s2s8)", 300,fIDPar->min_aoq_plot,fIDPar->max_aoq_plot, 400,1,4000,"A/Q s2-s8", "Z from s2tpc");
  ...
  SetupH2("aoq_vs_beta_S2-S8",600,fIDPar->min_aoq_plot,fIDPar->max_aoq_plot,600,0.74,0.78,"aoq S2-S8","beta S2-S8");
  SetupH2("dE(s2tpc)_vs_aoq(S2-S8)",400,fIDPar->min_aoq_plot,fIDPar->max_aoq_plot,500,0,3000,"AoQ S2-S8","dE(s2tpc)");
  SetupH1("Z(s2tpc)",400,fIDPar->min_z_plot,fIDPar->max_z_plot,"Z(s2tpc)");
  SetupH2("Z(s2tpc)_vs_aoq(S2-S8)",400,fIDPar->min_aoq_plot,fIDPar->max_aoq_plot,400,fIDPar->min_z_plot,fIDPar->max_z_plot,"AoQ S2-S8","Z(s2tpc)");
  SetupH2("dE(sc81)_vs_aoq(S2-S8)",400,fIDPar->min_aoq_plot,fIDPar->max_aoq_plot,500,0,3000,"AoQ S2-S8","dE(sc81)");
  SetupH1("Z(sc81)",1000,fIDPar->min_z_plot,fIDPar->max_z_plot,"Z(sc81)");
  SetupH2("Z(sc81)_vs_aoq(S2-S8)",400,fIDPar->min_aoq_plot,fIDPar->max_aoq_plot,400,fIDPar->min_z_plot,fIDPar->max_z_plot,"AoQ S2-S8","Z(sc81)");

  SetupH1("AoQ_S2-S4",1000,fIDPar->min_aoq_plot,fIDPar->max_aoq_plot,"AoQ S2-S4");
  SetupH2("aoq_vs_beta_S2-S4",600,fIDPar->min_aoq_plot,fIDPar->max_aoq_plot,600,0.74,0.78,"aoq S2-S4","beta S2-S4");
  SetupH2("dE(music41)_vs_aoq(S2-S4)",400,fIDPar->min_aoq_plot,fIDPar->max_aoq_plot,500,0,3000,"AoQ S2-S4","dE(music41)");
  SetupH1("Z(music41)",400,fIDPar->min_z_plot,fIDPar->max_z_plot,"Z(music41)");
  SetupH2("Z(music41)_vs_aoq(S2-S4)",400,fIDPar->min_aoq_plot,fIDPar->max_aoq_plot,400,fIDPar->min_z_plot,fIDPar->max_z_plot,"AoQ S2-S4","Z(music41)");
  SetupH2("dE(music42)_vs_aoq(S2-S4)",400,fIDPar->min_aoq_plot,fIDPar->max_aoq_plot,500,0,3000,"AoQ S2-S4","dE(music42)");
  SetupH1("Z(music42)",400,fIDPar->min_z_plot,fIDPar->max_z_plot,"Z(music42)");
  SetupH2("Z(music42)_vs_aoq(S2-S4)",400,fIDPar->min_aoq_plot,fIDPar->max_aoq_plot,400,fIDPar->min_z_plot,fIDPar->max_z_plot,"AoQ S2-S4","Z(music42)");
