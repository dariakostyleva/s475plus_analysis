...
// }
void TFRSUserProc::CopyPrevious(TFRSAnlEvent &anl) 
{
  ...
  previous.music1_x_mean = anl.music1_x_mean;
  previous.music2_x_mean = anl.music2_x_mean;
  previous.music3_x_mean = anl.music3_x_mean;
  ...
  for(int i=0;i<5;i++)
    {
      previous.id_b_x4AoQ[i]= anl.id_b_x4AoQ[i];  
      previous.id_b_x2AoQ[i]  = anl.id_b_x2AoQ[i];
...
void TFRSUserProc::Process_Analysis(TFRSSortEvent &srt, TFRSCalibrEvent &cal, TFRSAnlEvent &anl, TFRSUserEvent &tgt) 
{
  ...
  tgt.music1_x_mean = previous.music1_x_mean;
  ...
  for(int i=0;i<5;i++)
    {
      tgt.id_b_x4AoQ[i]  = previous.id_b_x4AoQ[i];  
      tgt.id_b_x2AoQ[i]  = previous.id_b_x2AoQ[i];
